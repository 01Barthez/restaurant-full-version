...
const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section className={`relative overflow-hidden pt-28 pb-16 md:pt-36 md:pb-4 shadow-md ${className}`}>
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-4 lg:space-y-6">
          <span className="inline-block px-5 py-1 text-xs font-medium bg-orange-50/80 dark:bg-amber-900/20 text-amber-700 dark:text-amber-300 border border-orange-200 dark:border-amber-800/50 rounded-full backdrop-blur-sm">
            {span}
          </span>

          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-primary dark:text-orange-500">
            {title}
          </h1>
